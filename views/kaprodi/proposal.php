<?php
// [PERBAIKAN] Hapus pemanggilan template dari baris ini, langsung mulai rekam konten.
ob_start();
?>
                ...
                <table class="table align-items-center table-flush" id="datatable-basic">
                    ...
                    <tbody class="list">
                        ...
                        <tr>
                            ...
                            <td><?= date('d/m/Y', strtotime($p->tanggal_penetapan ?: $p->id)) ?></td> <td>
...
<?php 
// Ambil semua konten di atas
$content = ob_get_clean(); 

// Mulai rekam lagi untuk skrip
ob_start(); 
?>
<script>
...
function viewDetail(id) {
    // Implementasi AJAX untuk detail jika diperlukan
    alert('Fungsi lihat detail untuk proposal ID: ' + id);
}
</script>
<?php 
// Ambil skrip
...
// Panggil template HANYA SATU KALI di akhir
