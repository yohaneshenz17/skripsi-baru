...
<body>
    ...
    <nav class="sidebar">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="<?= BASE_URL ?>modules/buku/index.php">
                    ...
                    <div class="col-md-6">
                        <form method="GET" action="">
                            <div class="input-group search-box">
                                <input type="text" class="form-control" name="search" placeholder="Cari nomor buku, judul, atau pengarang..." value="<?= $search ?>">
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?= $no++ ?></td>
                                <td><code><?= $row['nomor_buku'] ?></code></td>
