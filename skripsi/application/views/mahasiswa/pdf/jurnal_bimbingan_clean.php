...
<head>
    ...
    <style>
        /* ===== PDF-ONLY CLEAN TEMPLATE UNTUK MAHASISWA ===== */
        @page {
            size: A4 landscape;
            margin: 12mm 8mm;
        }
...
<body>
        ...
        <div class="info-columns">
            ...
            <div class="info-column-left">
                <div class="info-row">
                    ...
                    <div class="info-value">: <strong><?= isset($proposal->nama_mahasiswa) ? $proposal->nama_mahasiswa : 'Nama Mahasiswa' ?></strong></div>
                </div>
                
                <div class="info-row">
                    <div class="info-label">NIM</div>
                    <div class="info-value">: <strong><?= isset($proposal->nim) ? $proposal->nim : 'NIM' ?></strong></div>
                </div>
                
                <div class="info-row">
                    <div class="info-label">Program Studi</div>
                    <div class="info-value">: <?= isset($proposal->nama_prodi) ? $proposal->nama_prodi : 'Program Studi' ?></div>
                </div>
            </div>
            ...
            <div class="info-column-right">
                <div class="info-row">
                    ...
                    <div class="info-value">: <em><?= isset($proposal->judul) && !empty($proposal->judul) ? $proposal->judul : 'Judul Proposal/Skripsi' ?></em></div>
                </div>
                
                <div class="info-row">
                    <div class="info-label">Dosen Pembimbing</div>
                    <div class="info-value">: <strong><?= isset($proposal->nama_pembimbing) ? $proposal->nama_pembimbing : 'Nama Dosen Pembimbing' ?></strong></div>
                </div>
        ...
        <table class="signature-table">
            <tr>
                <td>
                    ...
                    <div class="signature-name"><?= isset($proposal->nama_mahasiswa) ? $proposal->nama_mahasiswa : 'Nama Mahasiswa' ?></div>
                    <div class="signature-nip">NIM. <?= isset($proposal->nim) ? $proposal->nim : 'NIM' ?></div>
                    <div class="signature-note">*Terverifikasi sistem digital</div>
                </td>
                <td>
                    <div class="signature-title">Dosen Pembimbing</div>
                    <div class="signature-name"><?= isset($proposal->nama_pembimbing) ? $proposal->nama_pembimbing : 'Nama Dosen Pembimbing' ?></div>
                    <div class="signature-nip">NIDN. <?= isset($proposal->nip_pembimbing) ? $proposal->nip_pembimbing : 'NIDN Dosen' ?></div>
                    <div class="signature-note">*Terverifikasi sistem digital</div>
                </td>
                <td>
    ...
    <div class="footer-info">
        <div class="generated-info">
            📄 Dokumen ini digenerate secara otomatis oleh <strong><?= isset($generated_by) ? $generated_by : 'Mahasiswa' ?></strong> pada <strong><?= isset($generated_at) ? $generated_at : date('d F Y H:i:s') ?></strong><br>
