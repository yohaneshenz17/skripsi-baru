          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?= base_url() ?>kaprodi/proposal">
                ...
                <span class="nav-link-text">Penetapan Pembimbing</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?= base_url() ?>kaprodi/riwayat">
                <i class="ni ni-bullet-list-67 text-green"></i>
                <span class="nav-link-text">Riwayat Penetapan</span>
              </a>
            </li>
            <!-- MENU BARU: Pengumuman Tahapan -->
            <li class="nav-item">
