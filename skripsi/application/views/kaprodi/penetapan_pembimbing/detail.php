    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <!-- Form Penetapan -->
                <form method="post" action="<?= base_url() ?>kaprodi/penetapan_pembimbing/simpan_penetapan" id="formPenetapan">
                    ...
                    <div class="text-right">
                        <a href="<?= base_url() ?>kaprodi/penetapan_pembimbing" class="btn btn-secondary">
    ...
    $('#formPenetapan').on('submit', function(e) {
        ...
        if (pembimbing === '' || penguji1 === '' || penguji2 === '') {
            ...
            Swal.fire({
                icon: 'warning',
                title: 'Peringatan',
                text: 'Semua dosen harus dipilih!',
        ...
        Swal.fire({
            ...
            html: 'Apakah Anda yakin ingin menetapkan:<br>' +
                  '<strong>Pembimbing:</strong> ' + $('#dosen_pembimbing_id option:selected').text() + '<br>' +
                  '<strong>Penguji 1:</strong> ' + $('#dosen_penguji1_id option:selected').text() + '<br>' +
                  '<strong>Penguji 2:</strong> ' + $('#dosen_penguji2_id option:selected').text() + '<br><br>' +
                  'Notifikasi akan dikirim ke mahasiswa dan dosen yang dipilih.',
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire({
                    title: 'Menyimpan...',
                    text: 'Mohon tunggu, sedang menyimpan penetapan',
