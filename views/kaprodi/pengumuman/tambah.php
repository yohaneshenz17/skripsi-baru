        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="mb-0">Tambah Pengumuman Tahapan Skripsi</h3>
                    </div>
            ...
            <div class="card-body">
                <form method="post" action="<?= base_url() ?>kaprodi/pengumuman/simpan">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-control-label">No. Urut <span class="text-danger">*</span></label>
                                <input type="number" class="form-control" name="no" required min="1" placeholder="Masukkan nomor urut">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="tahapan" required placeholder="Contoh: Pengajuan Proposal">
                    </div>
                    
                    <div class="form-group">
                        <label class="form-control-label">Keterangan</label>
                        <textarea class="form-control" name="keterangan" rows="3" placeholder="Masukkan keterangan tambahan (opsional)"></textarea>
                    </div>
