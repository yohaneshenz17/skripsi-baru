<?php
/**
 * Detail Seminar Proposal & Form Validasi Plagiarisme (FIXED - Template Integration)
                            ...
                            <div class="form-group">
                                ...
                                <p class="form-control-static">
                                    ...
                                    <small class="text-muted ml-2">
                                        <?php if(!empty($seminar->updated_at)): ?>
                                            <?= date('d/m/Y H:i', strtotime($seminar->updated_at)) ?>
                                        <?php else: ?>
                                            -
                                        <?php endif; ?>
                                    </small>
...
<div class="row mt-3">
    <div class="col-12">
        <a href="<?= base_url('kaprodi/seminar_proposal') ?>" class="btn btn-secondary">
...
$this->load->view('template/kaprodi', [
    'title' => 'Detail Seminar Proposal - ' . htmlspecialchars($seminar->nama_mahasiswa),
    'content' => $content,
    'script' => $script
]);
?>