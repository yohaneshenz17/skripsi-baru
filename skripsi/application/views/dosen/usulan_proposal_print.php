    ...
    <div class="info-section">
        ...
        <table class="info-table">
            ...
            <tr>
                ...
                <td><?= isset($proposal->nama_dosen_pembimbing) ? $proposal->nama_dosen_pembimbing : $this->session->userdata('nama') ?></td>
            </tr>
            <tr>
    ...
    <div class="info-section">
        ...
        <div class="timeline">
            <div class="timeline-item">
                <div class="timeline-date"><?= date('d F Y, H:i', strtotime($proposal->created_at)) ?> WIT</div>
                <div class="timeline-desc">Proposal diajukan oleh mahasiswa</div>
            </div>
            <?php if(!empty($proposal->tanggal_penetapan)): ?>
            <div class="timeline-item">
                <div class="timeline-date"><?= date('d F Y, H:i', strtotime($proposal->tanggal_penetapan)) ?> WIT</div>
                <div class="timeline-desc">Dosen pembimbing ditetapkan oleh Kaprodi (<?= $proposal->nama_kaprodi ?>)</div>
            </div>
            <?php endif; ?>
            <div class="timeline-item">
