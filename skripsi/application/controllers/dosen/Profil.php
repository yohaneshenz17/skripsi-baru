...
class Profil extends MY_Controller {
    ...
    public function update()
    {
        ...
        if ($this->input->post()) {
            $dosen_id = $this->session->userdata('id');
            error_log("DEBUG: Dosen ID from session: $dosen_id");
            ...
            error_log("DEBUG: No POST data, redirecting to profile");
    ...
    {
        error_log("DEBUG: _handle_photo_upload called with dosen_id: $dosen_id");
        error_log("DEBUG: FILES data: " . print_r($_FILES, true));
    ...
    private function _handle_data_update($dosen_id)
    {
        ...
        if ($email_exists > 0) {
            ...
            echo json_encode(['error' => true, 'message' => 'Email sudah digunakan oleh dosen lain.']);
            return;
        }
    ...
    {
        echo "<h2>DEBUG MODE - Dosen Profil Controller</h2>";
        ...
        echo "<hr><p><a href='" . base_url('dosen/profil') . "'>← Back to Profile</a></p>";
    }

    public function test_upload()
    {
        echo "<h2>DEBUG - Test Upload Process</h2>";
        ...
        if ($_POST) {
            ...
            echo 'Nama: <input type="text" name="nama" value="Test Name"><br><br>';
            echo 'Email: <input type="email" name="email" value="test@example.com"><br><br>';
