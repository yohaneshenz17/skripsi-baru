    ...
    <?php endif; ?>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <p class="text-muted mb-3">
                    <i class="fas fa-info-circle mr-1"></i>
                    Nilai rata-rata dari 3 penguji dengan bobot: Substansi & Metode (50%), Presentasi & Teknik (20%), Penguasaan & Diskusi (30%)
                </p>
                
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="font-weight-bold">Substansi & Metode Penelitian <span class="text-primary">(50%)</span> <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="font-weight-bold">Presentasi & Teknik Penyajian <span class="text-primary">(20%)</span> <span class="text-danger">*</span></label>
                            <div class="input-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="font-weight-bold">Penguasaan Materi & Diskusi <span class="text-primary">(30%)</span> <span class="text-danger">*</span></label>
                            <div class="input-group">
                        ...
                        <div class="alert alert-light border">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span class="font-weight-bold" id="previewNilaiAngka">
                                    <?= isset($penilaian) && $penilaian->nilai_akhir ? number_format($penilaian->nilai_akhir, 2) : '-' ?>
                                </span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                <span>Nilai Huruf:</span>
                                <span class="font-weight-bold" id="previewNilaiHuruf">
                                    <?= isset($penilaian) && $penilaian->nilai_huruf ? $penilaian->nilai_huruf : '-' ?>
                                </span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label class="font-weight-bold">Pilih Rekomendasi <span class="text-danger">*</span></label>
                    <div class="row">
                        <div class="col-md-6">
...
document.getElementById('penilaianForm').addEventListener('submit', function(e) {
    ...
    if (substansi <= 0 || presentasi <= 0 || penguasaan <= 0) {
        e.preventDefault();
        alert('Semua komponen nilai harus diisi dengan nilai > 0!');
        return false;
    }
    
    if (!rekomendasi) {
        e.preventDefault();
        alert('Rekomendasi hasil seminar harus dipilih!');
        return false;
    }
